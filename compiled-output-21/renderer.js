...
const SCENE_COUNT = 1;
const VARIABLE_COUNT = 85;
const LIST_COUNT = 12;
const ENTITY_COUNT = 2;
const STRING_POOL_START = 21496;
...
// ===== VARIABLE DATA =====
const VARIABLE_DATA = [
    { id: "39d6", name: "refraction", memoryOffset: 1328, visible: false, x: 18, y: -81, varType: "variable" },
    { id: "lb0g", name: "prev", memoryOffset: 1336, visible: false, x: 18, y: 89, varType: "variable" },
    { id: "oukf", name: "cos", memoryOffset: 1344, visible: false, x: 126, y: -6, varType: "variable" },
    { id: "o11m", name: "refractedz", memoryOffset: 1352, visible: false, x: -175, y: -21, varType: "variable" },
    { id: "w7g1", name: "refractedy", memoryOffset: 1360, visible: false, x: -154, y: -50, varType: "variable" },
    { id: "2zw5", name: "refractedx", memoryOffset: 1368, visible: false, x: 35, y: 39, varType: "variable" },
    { id: "9mvl", name: "tex color", memoryOffset: 1376, visible: false, x: -35, y: 62, varType: "variable" },
    { id: "6fqm", name: "보이기", memoryOffset: 1384, visible: false, x: 140.89932885906035, y: -97.79382520281709, varType: "variable" },
    { id: "b368", name: "cam z", memoryOffset: 1392, visible: false, x: -230, y: 91, varType: "variable" },
    { id: "xdl3", name: "cam y", memoryOffset: 1400, visible: false, x: -230, y: 91, varType: "variable" },
    { id: "c64h", name: "cam x", memoryOffset: 1408, visible: false, x: -230, y: 91, varType: "variable" },
    { id: "qsa9", name: "ver z", memoryOffset: 1416, visible: false, x: 130, y: 75, varType: "variable" },
    { id: "vq8t", name: "ver y", memoryOffset: 1424, visible: false, x: -58, y: -19, varType: "variable" },
    { id: "qq0m", name: "ver x", memoryOffset: 1432, visible: false, x: 152, y: 91, varType: "variable" },
    { id: "0ea8", name: "hor z", memoryOffset: 1440, visible: false, x: 47, y: 32, varType: "variable" },
    { id: "pjtj", name: "hor y", memoryOffset: 1448, visible: false, x: 188, y: -46, varType: "variable" },
    { id: "4d2s", name: "hor x", memoryOffset: 1456, visible: false, x: -148, y: -99, varType: "variable" },
    { id: "481t", name: "좌측상단 z", memoryOffset: 1464, visible: false, x: -76.16778523489936, y: 73.35060162253674, varType: "variable" },
    { id: "mdp2", name: "좌측상단 y", memoryOffset: 1472, visible: false, x: 57.966442953020135, y: 78.92726425069404, varType: "variable" },
    { id: "d9ni", name: "좌측 상단x", memoryOffset: 1480, visible: false, x: -84, y: 46, varType: "variable" },
    { id: "zuvg", name: "pixel z", memoryOffset: 1488, visible: false, x: -10, y: 64, varType: "variable" },
    { id: "a3mf", name: "pixel y", memoryOffset: 1496, visible: false, x: -114, y: -39, varType: "variable" },
    { id: "baj8", name: "pixel x", memoryOffset: 1504, visible: false, x: -42, y: 101, varType: "variable" },
    { id: "ionu", name: "view w", memoryOffset: 1512, visible: false, x: 143, y: -9, varType: "variable" },
    { id: "r8k7", name: "view h", memoryOffset: 1520, visible: false, x: -215, y: -31, varType: "variable" },
    { id: "evju", name: "focal dist", memoryOffset: 1528, visible: false, x: -87, y: 71, varType: "variable" },
    { id: "743z", name: "wz", memoryOffset: 1536, visible: false, x: -167, y: -45, varType: "variable" },
    { id: "pwp2", name: "wy", memoryOffset: 1544, visible: false, x: 163, y: -81, varType: "variable" },
    { id: "wmpr", name: "wx", memoryOffset: 1552, visible: false, x: -166, y: 3, varType: "variable" },
    { id: "k5u1", name: "viewport z", memoryOffset: 1560, visible: false, x: -120, y: 17, varType: "variable" },
    { id: "2ysc", name: "viewport y", memoryOffset: 1568, visible: false, x: -3, y: -68, varType: "variable" },
    { id: "e1cz", name: "viewport x", memoryOffset: 1576, visible: false, x: 179, y: 91, varType: "variable" },
    { id: "6q91", name: "FOV", memoryOffset: 1584, visible: false, x: 53, y: -24, varType: "variable" },
    { id: "i65c", name: "cross z", memoryOffset: 1592, visible: false, x: -62, y: -60, varType: "variable" },
    { id: "qu5m", name: "cross y", memoryOffset: 1600, visible: false, x: -40, y: -28, varType: "variable" },
    { id: "5szc", name: "cross x", memoryOffset: 1608, visible: false, x: -44.76510067114094, y: -90.57221341267692, varType: "variable" },
    { id: "qva3", name: "screen y", memoryOffset: 1616, visible: false, x: -23, y: 37, varType: "variable" },
    { id: "aaub", name: "screen x", memoryOffset: 1624, visible: false, x: -141, y: -19, varType: "variable" },
    { id: "n5gq", name: "random z", memoryOffset: 1632, visible: false, x: -230, y: 19, varType: "variable" },
    { id: "ocsc", name: "random y", memoryOffset: 1640, visible: false, x: -226, y: 90, varType: "variable" },
    { id: "kqfs", name: "random x", memoryOffset: 1648, visible: false, x: 112, y: 40, varType: "variable" },
    { id: "nv81", name: "final b", memoryOffset: 1656, visible: false, x: 58, y: -58, varType: "variable" },
    { id: "339r", name: "final g", memoryOffset: 1664, visible: false, x: -185, y: -2, varType: "variable" },
    { id: "kn3u", name: "final r", memoryOffset: 1672, visible: false, x: 9, y: -27, varType: "variable" },
    { id: "p5ul", name: "sample", memoryOffset: 1680, visible: false, x: -213.04026845637583, y: -63.4740975661949, varType: "slide", minValue: 1, maxValue: 200 },
    { id: "sdon", name: "diffuse z", memoryOffset: 1688, visible: false, x: 33, y: -78, varType: "variable" },
    { id: "337l", name: "diffuse y", memoryOffset: 1696, visible: false, x: 87, y: -49, varType: "variable" },
    { id: "drd6", name: "diffuse x", memoryOffset: 1704, visible: false, x: 11, y: -73, varType: "variable" },
    { id: "ppji", name: "mul z", memoryOffset: 1712, visible: false, x: -96, y: 90, varType: "variable" },
    { id: "41s4", name: "mul y", memoryOffset: 1720, visible: false, x: -110, y: -8, varType: "variable" },
    { id: "5fdi", name: "mul x", memoryOffset: 1728, visible: false, x: 81, y: -21, varType: "variable" },
    { id: "6imw", name: "sky color", memoryOffset: 1736, visible: false, x: 122, y: -105, varType: "variable" },
    { id: "d0uo", name: "mul", memoryOffset: 1744, visible: false, x: 61, y: -77, varType: "variable" },
    { id: "qqid", name: "reflectedz", memoryOffset: 1752, visible: false, x: 112, y: 91, varType: "variable" },
    { id: "incy", name: "reflectedy", memoryOffset: 1760, visible: false, x: 112, y: 91, varType: "variable" },
    { id: "m46o", name: "reflectedx", memoryOffset: 1768, visible: false, x: 112, y: 91, varType: "variable" },
    { id: "iwls", name: "light b", memoryOffset: 1776, visible: false, x: 99.11409395973158, y: 59.79382520281712, varType: "variable" },
    { id: "5h02", name: "light g", memoryOffset: 1784, visible: false, x: 98, y: 35, varType: "variable" },
    { id: "rbfm", name: "light r", memoryOffset: 1792, visible: false, x: 98, y: 12.556776419719654, varType: "variable" },
    { id: "zqxx", name: "bounce", memoryOffset: 1800, visible: false, x: -213.765100671141, y: -12.984563007042738, varType: "slide", minValue: 1, maxValue: 10 },
    { id: "7612", name: "sphere i", memoryOffset: 1808, visible: false, x: 47, y: -49, varType: "variable" },
    { id: "5d7w", name: "ray z", memoryOffset: 1816, visible: false, x: 30, y: -105, varType: "variable" },
    { id: "03uu", name: "ray y", memoryOffset: 1824, visible: false, x: 20, y: 111, varType: "variable" },
    { id: "tq2s", name: "ray x", memoryOffset: 1832, visible: false, x: 20, y: 83, varType: "variable" },
    { id: "t46g", name: "min t", memoryOffset: 1840, visible: false, x: -138, y: 7, varType: "variable" },
    { id: "yuj2", name: "norm2", memoryOffset: 1848, visible: false, x: -31, y: -77, varType: "variable" },
    { id: "ubh2", name: "normal z", memoryOffset: 1856, visible: false, x: -45, y: -49, varType: "variable" },
    { id: "95s8", name: "normal y", memoryOffset: 1864, visible: false, x: -62, y: -105, varType: "variable" },
    { id: "boko", name: "normal x", memoryOffset: 1872, visible: false, x: -72, y: 111, varType: "variable" },
    { id: "avih", name: "hit z1", memoryOffset: 1880, visible: false, x: -72, y: 83, varType: "variable" },
    { id: "n1y1", name: "hit y1", memoryOffset: 1888, visible: false, x: -93, y: 55, varType: "variable" },
    { id: "f20e", name: "hit x1", memoryOffset: 1896, visible: false, x: -111, y: -21, varType: "variable" },
    { id: "8ptk", name: "t1", memoryOffset: 1904, visible: false, x: -111, y: -49, varType: "variable" },
    { id: "pwpc", name: "t0", memoryOffset: 1912, visible: false, x: -138, y: 91, varType: "variable" },
    { id: "e1qp", name: "norm", memoryOffset: 1920, visible: false, x: -138, y: -77, varType: "variable" },
    { id: "8qyz", name: "res", memoryOffset: 1928, visible: false, x: -226.59060402684565, y: -111.41234959436582, varType: "slide", minValue: 0.2, maxValue: 15 },
    { id: "04h3", name: "ray dir z", memoryOffset: 1936, visible: false, x: -230, y: 63, varType: "variable" },
    { id: "rn3w", name: "ray dir y", memoryOffset: 1944, visible: false, x: -230, y: 35, varType: "variable" },
    { id: "y1ia", name: "ray dir x", memoryOffset: 1952, visible: false, x: -228.38926174496643, y: 8.603087398591441, varType: "variable" },
    { id: "px4n", name: "origin z", memoryOffset: 1960, visible: false, x: -230, y: -21, varType: "variable" },
    { id: "vd4a", name: "origin y", memoryOffset: 1968, visible: false, x: -230, y: -49, varType: "variable" },
    { id: "x4sq", name: "origin x", memoryOffset: 1976, visible: false, x: -230, y: -77, varType: "variable" },
    { id: "rqnt", name: "width", memoryOffset: 1984, visible: false, x: 100, y: 27, varType: "variable" },
    { id: "8rfs", name: "height", memoryOffset: 1992, visible: false, x: 107, y: 112, varType: "variable" },
    { id: "j4xi", name: "image", memoryOffset: 2000, visible: false, x: 100, y: -1, varType: "variable" },
];
...
// ===== LIST DATA =====
const LIST_DATA = [
    { id: "gb4x", name: "refraction", memoryIndex: 0, visible: false, x: 10, y: 4, width: 100, height: 120 },
    { id: "rbng", name: "texture", memoryIndex: 1, visible: false, x: 10, y: -20, width: 100, height: 120 },
    { id: "pa3d", name: "image", memoryIndex: 2, visible: false, x: 10, y: -44, width: 100, height: 120 },
    { id: "icqa", name: "e power", memoryIndex: 3, visible: false, x: 10, y: -68, width: 100, height: 120 },
    { id: "t976", name: "emission", memoryIndex: 4, visible: false, x: 10, y: -92, width: 100, height: 120 },
    { id: "bwcu", name: "metalic", memoryIndex: 5, visible: false, x: 10, y: -116, width: 100, height: 120 },
    { id: "uoxk", name: "smoothness", memoryIndex: 6, visible: false, x: 120, y: 5, width: 100, height: 120 },
    { id: "xxun", name: "color", memoryIndex: 7, visible: false, x: 120, y: -19, width: 100, height: 120 },
    { id: "6fa3", name: "sphere z", memoryIndex: 8, visible: false, x: 120, y: -43, width: 100, height: 120 },
    { id: "4rb5", name: "sphere y", memoryIndex: 9, visible: false, x: 120, y: -67, width: 100, height: 120 },
    { id: "fi2d", name: "sphere x", memoryIndex: 10, visible: false, x: 120, y: -91, width: 100, height: 120 },
    { id: "76i3", name: "sphere r", memoryIndex: 11, visible: false, x: 120, y: -115, width: 100, height: 120 },
];
...
const ENTITY_DATA = [
    {
        id: "0z9b",
        name: "다운로드 - 2024-01-30T104945.123.png",
        objectType: "sprite",
        pictures: [
            { id: "55to", url: "/uploads/c2/36/image/c2368c46lrzpbj370ipma2c943culfv4.png", width: 960, height: 540 },
            { id: "aas7", url: "/uploads/d0/cd/image/d0cd2ac7lsa6n0ih0v3o6268dfbjgeem.png", width: 960, height: 538 },
        ],
        sounds: [
        ],
        sceneIndex: 0

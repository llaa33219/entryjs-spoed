...
const SCENE_COUNT = 1;
const VARIABLE_COUNT = 119;
const LIST_COUNT = 36;
const ENTITY_COUNT = 1;
const STRING_POOL_START = 60592;
...
// ===== VARIABLE DATA =====
const VARIABLE_DATA = [
    { id: "atxh", name: "uv3", memoryOffset: 1176, visible: false, x: -100, y: -77, varType: "variable" },
    { id: "qp3l", name: "uv2", memoryOffset: 1184, visible: false, x: -192, y: 113, varType: "variable" },
    { id: "3e8p", name: "uv1", memoryOffset: 1192, visible: false, x: 48, y: 37, varType: "variable" },
    { id: "o7hp", name: "complete", memoryOffset: 1200, visible: false, x: 87, y: 59, varType: "variable" },
    { id: "zqxx", name: "bounce", memoryOffset: 1208, visible: false, x: -213.765100671141, y: -12.984563007042738, varType: "slide", minValue: 1, maxValue: 10 },
    { id: "p5ul", name: "sample", memoryOffset: 1216, visible: false, x: -213.04026845637583, y: -63.4740975661949, varType: "slide", minValue: 1, maxValue: 200 },
    { id: "8qyz", name: "res", memoryOffset: 1224, visible: false, x: -226.59060402684565, y: -111.41234959436582, varType: "slide", minValue: 0.2, maxValue: 15 },
    { id: "6imw", name: "sky color", memoryOffset: 1232, visible: false, x: 122, y: -105, varType: "variable" },
    { id: "rqnt", name: "width", memoryOffset: 1240, visible: false, x: 100, y: 27, varType: "variable" },
    { id: "8rfs", name: "height", memoryOffset: 1248, visible: false, x: 107, y: 112, varType: "variable" },
    { id: "9ywy", name: "max dist", memoryOffset: 1256, visible: false, x: -138, y: -105, varType: "variable" },
    { id: "js96", name: "min dist", memoryOffset: 1264, visible: false, x: -133, y: -49, varType: "variable" },
    { id: "5szc", name: "cross x", memoryOffset: 1272, visible: false, x: -44.76510067114094, y: -90.57221341267692, varType: "variable" },
    { id: "qu5m", name: "cross y", memoryOffset: 1280, visible: false, x: -40, y: -28, varType: "variable" },
    { id: "i65c", name: "cross z", memoryOffset: 1288, visible: false, x: -62, y: -60, varType: "variable" },
    { id: "thfa", name: "file", memoryOffset: 1296, visible: false, x: -18, y: 70, varType: "variable" },
    { id: "0fgi", name: "obj mat", memoryOffset: 1304, visible: false, x: 13, y: 35, varType: "variable" },
    { id: "8euv", name: "size", memoryOffset: 1312, visible: false, x: -227, y: -53, varType: "variable" },
    { id: "jzk0", name: "x offset", memoryOffset: 1320, visible: false, x: 151, y: 22, varType: "variable" },
    { id: "1eet", name: "y offset", memoryOffset: 1328, visible: false, x: -23, y: -27, varType: "variable" },
    { id: "0hm0", name: "z offset", memoryOffset: 1336, visible: false, x: -169, y: 31, varType: "variable" },
    { id: "iwa0", name: "flip z", memoryOffset: 1344, visible: false, x: 163, y: -89, varType: "variable" },
    { id: "0t71", name: "delay", memoryOffset: 1352, visible: false, x: -142, y: -80, varType: "variable" },
    { id: "ibep", name: "file(enc)", memoryOffset: 1360, visible: false, x: 116, y: -37, varType: "variable" },
    { id: "rp4y", name: "특수문자", memoryOffset: 1368, visible: false, x: 42, y: 54, varType: "variable" },
    { id: "8kl4", name: "temp", memoryOffset: 1376, visible: false, x: -15, y: 85, varType: "variable" },
    { id: "oqa3", name: "i", memoryOffset: 1384, visible: false, x: 48, y: 81, varType: "variable" },
    { id: "krma", name: "i offset", memoryOffset: 1392, visible: false, x: -212, y: 37, varType: "variable" },
    { id: "6q91", name: "FOV", memoryOffset: 1400, visible: false, x: 53, y: -24, varType: "variable" },
    { id: "c64h", name: "cam x", memoryOffset: 1408, visible: false, x: -230, y: 91, varType: "variable" },
    { id: "xdl3", name: "cam y", memoryOffset: 1416, visible: false, x: -230, y: 91, varType: "variable" },
    { id: "b368", name: "cam z", memoryOffset: 1424, visible: false, x: -230, y: 91, varType: "variable" },
    { id: "tq2s", name: "ray x", memoryOffset: 1432, visible: false, x: 20, y: 83, varType: "variable" },
    { id: "03uu", name: "ray y", memoryOffset: 1440, visible: false, x: 20, y: 111, varType: "variable" },
    { id: "5d7w", name: "ray z", memoryOffset: 1448, visible: false, x: 30, y: -105, varType: "variable" },
    { id: "e1cz", name: "viewport x", memoryOffset: 1456, visible: false, x: 179, y: 91, varType: "variable" },
    { id: "2ysc", name: "viewport y", memoryOffset: 1464, visible: false, x: -3, y: -68, varType: "variable" },
    { id: "k5u1", name: "viewport z", memoryOffset: 1472, visible: false, x: -120, y: 17, varType: "variable" },
    { id: "yuj2", name: "norm2", memoryOffset: 1480, visible: false, x: -31, y: -77, varType: "variable" },
    { id: "evju", name: "focal dist", memoryOffset: 1488, visible: false, x: -87, y: 71, varType: "variable" },
    { id: "wmpr", name: "wx", memoryOffset: 1496, visible: false, x: -166, y: 3, varType: "variable" },
    { id: "pwp2", name: "wy", memoryOffset: 1504, visible: false, x: 163, y: -81, varType: "variable" },
    { id: "743z", name: "wz", memoryOffset: 1512, visible: false, x: -167, y: -45, varType: "variable" },
    { id: "r8k7", name: "view h", memoryOffset: 1520, visible: false, x: -215, y: -31, varType: "variable" },
    { id: "ionu", name: "view w", memoryOffset: 1528, visible: false, x: 143, y: -9, varType: "variable" },
    { id: "4d2s", name: "hor x", memoryOffset: 1536, visible: false, x: -148, y: -99, varType: "variable" },
    { id: "pjtj", name: "hor y", memoryOffset: 1544, visible: false, x: 188, y: -46, varType: "variable" },
    { id: "0ea8", name: "hor z", memoryOffset: 1552, visible: false, x: 47, y: 32, varType: "variable" },
    { id: "qq0m", name: "ver x", memoryOffset: 1560, visible: false, x: 152, y: 91, varType: "variable" },
    { id: "vq8t", name: "ver y", memoryOffset: 1568, visible: false, x: -58, y: -19, varType: "variable" },
    { id: "qsa9", name: "ver z", memoryOffset: 1576, visible: false, x: 130, y: 75, varType: "variable" },
    { id: "d9ni", name: "좌측 상단x", memoryOffset: 1584, visible: false, x: -84, y: 46, varType: "variable" },
    { id: "mdp2", name: "좌측상단 y", memoryOffset: 1592, visible: false, x: 57.966442953020135, y: 78.92726425069404, varType: "variable" },
    { id: "481t", name: "좌측상단 z", memoryOffset: 1600, visible: false, x: -76.16778523489936, y: 73.35060162253674, varType: "variable" },
    { id: "kn3u", name: "final r", memoryOffset: 1608, visible: false, x: 9, y: -27, varType: "variable" },
    { id: "339r", name: "final g", memoryOffset: 1616, visible: false, x: -185, y: -2, varType: "variable" },
    { id: "nv81", name: "final b", memoryOffset: 1624, visible: false, x: 58, y: -58, varType: "variable" },
    { id: "rbfm", name: "light r", memoryOffset: 1632, visible: false, x: 98, y: 12.556776419719654, varType: "variable" },
    { id: "5h02", name: "light g", memoryOffset: 1640, visible: false, x: 98, y: 35, varType: "variable" },
    { id: "iwls", name: "light b", memoryOffset: 1648, visible: false, x: 99.11409395973158, y: 59.79382520281712, varType: "variable" },
    { id: "baj8", name: "pixel x", memoryOffset: 1656, visible: false, x: -42, y: 101, varType: "variable" },
    { id: "a3mf", name: "pixel y", memoryOffset: 1664, visible: false, x: -114, y: -39, varType: "variable" },
    { id: "zuvg", name: "pixel z", memoryOffset: 1672, visible: false, x: -10, y: 64, varType: "variable" },
    { id: "y1ia", name: "ray dir x", memoryOffset: 1680, visible: false, x: -228.38926174496643, y: 8.603087398591441, varType: "variable" },
    { id: "rn3w", name: "ray dir y", memoryOffset: 1688, visible: false, x: -230, y: 35, varType: "variable" },
    { id: "04h3", name: "ray dir z", memoryOffset: 1696, visible: false, x: -230, y: 63, varType: "variable" },
    { id: "5fdi", name: "mul x", memoryOffset: 1704, visible: false, x: 81, y: -21, varType: "variable" },
    { id: "41s4", name: "mul y", memoryOffset: 1712, visible: false, x: -110, y: -8, varType: "variable" },
    { id: "ppji", name: "mul z", memoryOffset: 1720, visible: false, x: -96, y: 90, varType: "variable" },
    { id: "rpj7", name: "hit obj", memoryOffset: 1728, visible: false, x: -90, y: 110, varType: "variable" },
    { id: "t46g", name: "min t", memoryOffset: 1736, visible: false, x: -138, y: 7, varType: "variable" },
    { id: "kln7", name: "mat index", memoryOffset: 1744, visible: false, x: -24, y: -56, varType: "variable" },
    { id: "j4xi", name: "image", memoryOffset: 1752, visible: false, x: 100, y: -1, varType: "variable" },
    { id: "9mvl", name: "tex color", memoryOffset: 1760, visible: false, x: -35, y: 62, varType: "variable" },
    { id: "ubh2", name: "normal z", memoryOffset: 1768, visible: false, x: -45, y: -49, varType: "variable" },
    { id: "boko", name: "normal x", memoryOffset: 1776, visible: false, x: -72, y: 111, varType: "variable" },
    { id: "95s8", name: "normal y", memoryOffset: 1784, visible: false, x: -62, y: -105, varType: "variable" },
    { id: "2qs5", name: "collide x", memoryOffset: 1792, visible: false, x: 7, y: -32, varType: "variable" },
    { id: "mooy", name: "collide y", memoryOffset: 1800, visible: false, x: -175, y: -57, varType: "variable" },
    { id: "1eua", name: "collide z", memoryOffset: 1808, visible: false, x: 100, y: -30, varType: "variable" },
    { id: "drd6", name: "diffuse x", memoryOffset: 1816, visible: false, x: 11, y: -73, varType: "variable" },
    { id: "kqfs", name: "random x", memoryOffset: 1824, visible: false, x: 112, y: 40, varType: "variable" },
    { id: "337l", name: "diffuse y", memoryOffset: 1832, visible: false, x: 87, y: -49, varType: "variable" },
    { id: "ocsc", name: "random y", memoryOffset: 1840, visible: false, x: -226, y: 90, varType: "variable" },
    { id: "sdon", name: "diffuse z", memoryOffset: 1848, visible: false, x: 33, y: -78, varType: "variable" },
    { id: "n5gq", name: "random z", memoryOffset: 1856, visible: false, x: -230, y: 19, varType: "variable" },
    { id: "m46o", name: "reflectedx", memoryOffset: 1864, visible: false, x: 112, y: 91, varType: "variable" },
    { id: "incy", name: "reflectedy", memoryOffset: 1872, visible: false, x: 112, y: 91, varType: "variable" },
    { id: "qqid", name: "reflectedz", memoryOffset: 1880, visible: false, x: 112, y: 91, varType: "variable" },
    { id: "oukf", name: "cos", memoryOffset: 1888, visible: false, x: 126, y: -6, varType: "variable" },
    { id: "39d6", name: "refraction", memoryOffset: 1896, visible: false, x: 18, y: -81, varType: "variable" },
    { id: "7612", name: "hit i", memoryOffset: 1904, visible: false, x: 47, y: -49, varType: "variable" },
    { id: "2zw5", name: "refractedx", memoryOffset: 1912, visible: false, x: 35, y: 39, varType: "variable" },
    { id: "w7g1", name: "refractedy", memoryOffset: 1920, visible: false, x: -154, y: -50, varType: "variable" },
    { id: "o11m", name: "refractedz", memoryOffset: 1928, visible: false, x: -175, y: -21, varType: "variable" },
    { id: "e1fr", name: "sky r", memoryOffset: 1936, visible: false, x: 50, y: -77, varType: "variable" },
    { id: "bkrd", name: "sky g", memoryOffset: 1944, visible: false, x: 43, y: 78, varType: "variable" },
    { id: "7xd5", name: "sky b", memoryOffset: 1952, visible: false, x: 31, y: -3, varType: "variable" },
    { id: "x4sq", name: "origin x", memoryOffset: 1960, visible: false, x: -230, y: -77, varType: "variable" },
    { id: "vd4a", name: "origin y", memoryOffset: 1968, visible: false, x: -230, y: -49, varType: "variable" },
    { id: "px4n", name: "origin z", memoryOffset: 1976, visible: false, x: -230, y: -21, varType: "variable" },
    { id: "pwpc", name: "t0", memoryOffset: 1984, visible: false, x: -138, y: 91, varType: "variable" },
    { id: "8ptk", name: "t1", memoryOffset: 1992, visible: false, x: -111, y: -49, varType: "variable" },
    { id: "jvex", name: "u", memoryOffset: 2000, visible: false, x: 59, y: -21, varType: "variable" },
    { id: "qtys", name: "v", memoryOffset: 2008, visible: false, x: -1, y: 8, varType: "variable" },
    { id: "6mpo", name: "hit u", memoryOffset: 2016, visible: false, x: -175, y: -3, varType: "variable" },
    { id: "3bl4", name: "hit v", memoryOffset: 2024, visible: false, x: -45, y: -4, varType: "variable" },
    { id: "9rty", name: "current x", memoryOffset: 2032, visible: false, x: -11, y: -41, varType: "variable" },
    { id: "udrk", name: "current y", memoryOffset: 2040, visible: false, x: 156, y: -103, varType: "variable" },
    { id: "k9v3", name: "current z", memoryOffset: 2048, visible: false, x: -100, y: 30, varType: "variable" },
    { id: "oof5", name: "min sdf", memoryOffset: 2056, visible: false, x: -152, y: 91, varType: "variable" },
    { id: "ajm4", name: "hit i temp", memoryOffset: 2064, visible: false, x: -170, y: 6, varType: "variable" },
    { id: "ur98", name: "sdf", memoryOffset: 2072, visible: false, x: -230, y: 91, varType: "variable" },
    { id: "71qs", name: "px", memoryOffset: 2080, visible: false, x: 83, y: -71, varType: "variable" },
    { id: "2wpn", name: "py", memoryOffset: 2088, visible: false, x: 135, y: 2, varType: "variable" },
    { id: "iaf9", name: "pz", memoryOffset: 2096, visible: false, x: 182, y: -55, varType: "variable" },
    { id: "2tfr", name: "var12", memoryOffset: 2104, visible: false, x: 22, y: 59, varType: "variable" },
    { id: "18oc", name: "var11", memoryOffset: 2112, visible: false, x: 19, y: -51, varType: "variable" },
    { id: "x0sz", name: "limit", memoryOffset: 2120, visible: false, x: -203, y: -4, varType: "variable" },
];
...
// ===== LIST DATA =====
const LIST_DATA = [
    { id: "i2w4", name: "uv", memoryIndex: 0, visible: false, x: 120, y: -115, width: 100, height: 120 },
    { id: "l9vz", name: "3d mesh", memoryIndex: 1, visible: false, x: 120, y: 1, width: 100, height: 120 },
    { id: "xxun", name: "color", memoryIndex: 2, visible: false, x: 120, y: -19, width: 100, height: 120 },
    { id: "uoxk", name: "smoothness", memoryIndex: 3, visible: false, x: 120, y: 5, width: 100, height: 120 },
    { id: "t976", name: "emission", memoryIndex: 4, visible: false, x: 10, y: -92, width: 100, height: 120 },
    { id: "icqa", name: "e power", memoryIndex: 5, visible: false, x: 10, y: -68, width: 100, height: 120 },
    { id: "rbng", name: "texture", memoryIndex: 6, visible: false, x: 10, y: -20, width: 100, height: 120 },
    { id: "gb4x", name: "refraction", memoryIndex: 7, visible: false, x: 10, y: 4, width: 100, height: 120 },
    { id: "pbbe", name: "vertex x", memoryIndex: 8, visible: false, x: 133.5570469798658, y: 28.834642292950463, width: 100, height: 120 },
    { id: "itak", name: "vertex y", memoryIndex: 9, visible: false, x: -33.959731543624116, y: -115.48953455915212, width: 100, height: 120 },
    { id: "7vd0", name: "vertex z", memoryIndex: 10, visible: false, x: -157.98657718120805, y: -110.72658334224954, width: 100, height: 120 },
    { id: "4sc8", name: "tri (v1)", memoryIndex: 11, visible: false, x: -107.11409395973152, y: 57.61629783883973, width: 100, height: 120 },
    { id: "l6d0", name: "tri (v2)", memoryIndex: 12, visible: false, x: 43.977460435380095, y: 37.24974371359056, width: 100, height: 120 },
    { id: "hfdh", name: "tri (v3)", memoryIndex: 13, visible: false, x: -184.44142667953588, y: -7.926243138081745, width: 100, height: 120 },
    { id: "naej", name: "vertex u", memoryIndex: 14, visible: false, x: -80.67114093959728, y: 14.314233747883776, width: 100, height: 120 },
    { id: "psv9", name: "vertex v", memoryIndex: 15, visible: false, x: 40.13422818791949, y: -73.90188415351797, width: 100, height: 120 },
    { id: "pu3f", name: "v normal x", memoryIndex: 16, visible: false, x: -221.20536912751683, y: -48.90810304686106, width: 100, height: 120 },
    { id: "qzsk", name: "v normal y", memoryIndex: 17, visible: false, x: -99.53020134228183, y: -51.969126014085475, width: 100, height: 120 },
    { id: "58zh", name: "v normal z", memoryIndex: 18, visible: false, x: 26.107382550335615, y: 24.932758139432437, width: 100, height: 120 },
    { id: "4tnn", name: "t normal x", memoryIndex: 19, visible: false, x: 10, y: -20, width: 100, height: 120 },
    { id: "nj29", name: "t normal y", memoryIndex: 20, visible: false, x: 0.6188925081433467, y: -132.955109630643, width: 100, height: 120 },
    { id: "qk24", name: "t normal z", memoryIndex: 21, visible: false, x: -100, y: -117, width: 100, height: 120 },
    { id: "ncbu", name: "tri mat", memoryIndex: 22, visible: false, x: 120, y: -23, width: 100, height: 120 },
    { id: "fi2d", name: "sphere x", memoryIndex: 23, visible: false, x: 120, y: -91, width: 100, height: 120 },
    { id: "4rb5", name: "sphere y", memoryIndex: 24, visible: false, x: 120, y: -67, width: 100, height: 120 },
    { id: "6fa3", name: "sphere z", memoryIndex: 25, visible: false, x: 120, y: -43, width: 100, height: 120 },
    { id: "76i3", name: "sphere r", memoryIndex: 26, visible: false, x: 120, y: -115, width: 100, height: 120 },
    { id: "nsmc", name: "sphere mat", memoryIndex: 27, visible: false, x: 120, y: -23, width: 100, height: 120 },
    { id: "44ou", name: "obj lines", memoryIndex: 28, visible: false, x: -239.66442953020126, y: -129.6185243915487, width: 466.78494505584035, height: 237.53729781566204 },
    { id: "owrb", name: "obj", memoryIndex: 29, visible: false, x: 120, y: -115, width: 100, height: 120 },
    { id: "pa3d", name: "image", memoryIndex: 30, visible: false, x: 10, y: -44, width: 100, height: 120 },
    { id: "8fsq", name: "rm mat", memoryIndex: 31, visible: false, x: 10, y: -92, width: 100, height: 120 },
    { id: "7ce4", name: "x", memoryIndex: 32, visible: false, x: 120, y: -91, width: 100, height: 120 },
    { id: "r667", name: "y", memoryIndex: 33, visible: false, x: 120, y: -67, width: 100, height: 120 },
    { id: "lg33", name: "z", memoryIndex: 34, visible: false, x: 120, y: -19, width: 100, height: 120 },
    { id: "slas", name: "parameter", memoryIndex: 35, visible: false, x: 120, y: -19, width: 100, height: 120 },
];

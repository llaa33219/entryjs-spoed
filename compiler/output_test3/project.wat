(module
  ...
  (global $var_visible_0 (mut i32) (i32.const 0)) ;; 초시계
  (global $var_visible_1 (mut i32) (i32.const 0)) ;; 대답
  (global $dialog_type_0 (mut i32) (i32.const 0))
  (global $dialog_text_ptr_0 (mut i32) (i32.const 0))
  (global $str_pool_ptr (mut i32) (i32.const 1160))
  ...
  (func $user_func_umm6 (param $entityIdx i32) (param $param_0 f64) (param $param_1 f64) 
    (local $temp f64)
    ...
    (local $temp_str_ptr i32)
          ...
          (call $unpackAndSetBrushColor (local.get $entityIdx) (local.get $param_1))
  )
  
  ;; User function: func_1
  (func $user_func_llbr (param $entityIdx i32) (param $param_0 f64) (param $param_1 f64) (param $param_2 f64) (result f64)
    (local $temp f64)
    (local $condResult i32)
    (local $temp_str_ptr i32)
    (local $local_0 f64) ;; 지역변수
          ...
          ;; set_func_variable
          (local.set $local_0 (f64.add
          (f64.add
            (f64.mul (call $floor (local.get $param_0)) (f64.const 65536))
            (f64.mul (call $floor (local.get $param_1)) (f64.const 256)))
          (call $floor (local.get $param_2))))
    ;; Return value
    (local.get $local_0)
  )
  
  ;; User function: func_2
  (func $user_func_2bmc (param $entityIdx i32) (param $param_0 f64) 
    (local $temp f64)
    (local $condResult i32)
    (local $temp_str_ptr i32)
    
          ;; set_color: dynamic packed color
          (call $unpackAndSetBrushColor (local.get $entityIdx) (call $user_func_llbr (local.get $entityIdx) (f64.const 0) (local.get $param_0) (f64.const 255)))
  )
  
  ;; User function: func_3
  (func $user_func_hvk9 (param $entityIdx i32) (param $param_0 f64) (param $param_1 f64) 
    (local $temp f64)
    (local $condResult i32)
    (local $temp_str_ptr i32)
          ...
          (call $unpackAndSetFillColor (local.get $entityIdx) (local.get $param_0))
  )
  
  ;; User function: func_4
  (func $user_func_z6dt (param $entityIdx i32) (param $param_0 f64) 
    (local $temp f64)
    (local $condResult i32)
    (local $temp_str_ptr i32)
    
          ;; set_fill_color: dynamic packed color
          (call $unpackAndSetFillColor (local.get $entityIdx) (call $user_func_llbr (local.get $entityIdx) (f64.const 255) (local.get $param_0) (f64.const 10)))
  )
    ...
    (block $end
      (block $done
        (block $pc_0
          ...
          ;; set_thickness
          (call $setBrushThickness (i32.const 0) (f64.const 5))
        ...
        (block $pc_2
          ...
          (call $setBrushColorRGB (i32.const 0) (f64.const 255) (f64.const 0) (f64.const 255))
          (local.set $pc (i32.add (local.get $pc) (i32.const 1)))
          (global.set $thread_0_pc (local.get $pc))
          (global.set $thread_0_resumeDepth (i32.const 0))
          (br $done))
        (block $pc_3
          ...
          (call $setX (i32.const 0)
            (f64.add (call $getX (i32.const 0)) (f64.const 50)))
        ...
        (block $pc_4
          ...
          ;; set_color: dynamic packed color
          (call $unpackAndSetBrushColor (i32.const 0) (call $user_func_llbr (i32.const 0) (f64.const 0) (f64.const 255) (f64.const 0)))
          (local.set $pc (i32.add (local.get $pc) (i32.const 1)))
          (global.set $thread_0_pc (local.get $pc))
          (global.set $thread_0_resumeDepth (i32.const 0))
          (br $done))
        (block $pc_5
          ...
          (call $setY (i32.const 0)
            (f64.add (call $getY (i32.const 0)) (f64.const -50)))
          (call $brushNotifyPosition (i32.const 0) (call $getX (i32.const 0)) (call $getY (i32.const 0)))
          (local.set $pc (i32.add (local.get $pc) (i32.const 1)))
          (global.set $thread_0_pc (local.get $pc))
          (global.set $thread_0_resumeDepth (i32.const 0))
        ...
        (block $pc_6
          ...
          (call $user_func_2bmc (i32.const 0) (f64.const 255))
          (local.set $pc (i32.add (local.get $pc) (i32.const 1)))
          (global.set $thread_0_pc (local.get $pc))
          (global.set $thread_0_resumeDepth (i32.const 0))
          (br $done))
        ...
        (block $pc_9
          ...
          (call $user_func_hvk9 (i32.const 0) (f64.const 0) (f64.const 0))
          (local.set $pc (i32.add (local.get $pc) (i32.const 1)))
          (global.set $thread_0_pc (local.get $pc))
          (global.set $thread_0_resumeDepth (i32.const 0))
          (br $done))
        ...
        (block $pc_12
          ...
          (call $user_func_z6dt (i32.const 0) (f64.const 230))
          (local.set $pc (i32.add (local.get $pc) (i32.const 1)))
          (global.set $thread_0_pc (local.get $pc))
          (global.set $thread_0_resumeDepth (i32.const 0))
          (br $done))
        ...
        (block $pc_15
          ...
          ;; set_fill_color: dynamic packed color
          (call $unpackAndSetFillColor (i32.const 0) (call $user_func_llbr (i32.const 0) (f64.const 0) (f64.const 255) (f64.const 0)))
          (local.set $pc (i32.add (local.get $pc) (i32.const 1)))
          (global.set $thread_0_pc (local.get $pc))
          (global.set $thread_0_resumeDepth (i32.const 0))
          (br $done))
  ...
  ;; Thread 1: func_umm6 for entity 0
  ...
  (func $init
    ...
    (call $setX (i32.const 0) (f64.const -98.5))
    (call $setY (i32.const 0) (f64.const 124.44))
  ...
  (func $tick (param $dt f64)
    ...
    (global.set $str_pool_ptr (i32.const 1160))

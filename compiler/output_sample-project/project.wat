(module
  ...
  (global $var_visible_0 (mut i32) (i32.const 1)) ;; 점수
  ...
  (global $str_pool_ptr (mut i32) (i32.const 1272))
  ...
  (func $setDialogTextPtr_1 (param $v i32) (global.set $dialog_text_ptr_1 (local.get $v)))
      ...
      (block $done
        (block $pc_0
          ...
          (if (i32.eq (global.get $thread_2_loopCounter_0) (i32.const -1))
            (then
              (global.set $thread_2_loopCounter_0 (i32.trunc_f64_s (f64.const 5)))))
          ;; Check if iterations remain (counter > 0)
          (if (i32.gt_s (global.get $thread_2_loopCounter_0) (i32.const 0))
            (then
  ...
  (func $tick (param $dt f64)
    ...
    (global.set $str_pool_ptr (i32.const 1272))

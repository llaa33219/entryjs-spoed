    ...
    (block $end
      (block $done
        (block $pc_0
          ...
          ;; set_variable: 변수
          (call $setVariable (i32.const 1144) (f64.const 1))
        ...
        (block $pc_1
          ...
          ;; _if
          (if (f64.gt (call $getVariable (i32.const 1144)) (f64.convert_i32_s (call $list_length (i32.const 0))))
            (then 
          ;; dialog: speak
          (call $setDialogTextPtr_0 (block (result i32)
            (local.set $temp_str_ptr (call $str_alloc (i32.const 3)))
            (i32.store8 (i32.add (i32.add (local.get $temp_str_ptr) (i32.const 4)) (i32.const 0)) (i32.const 235))
            (i32.store8 (i32.add (i32.add (local.get $temp_str_ptr) (i32.const 4)) (i32.const 1)) (i32.const 129))
            (i32.store8 (i32.add (i32.add (local.get $temp_str_ptr) (i32.const 4)) (i32.const 2)) (i32.const 157))
          ...
          ;; stop_object: thisThread
          (global.set $thread_0_active (i32.const 0))
          (return (i32.const 0))))
          ;; _if
          (if (f64.gt (call $list_get (i32.const 0) (i32.trunc_f64_s (f64.sub (f64.add (call $getVariable (i32.const 1144)) (f64.const 0)) (f64.const 1)))) (f64.const -16777216))
            (then 
          ;; dialog: speak
          (call $setDialogTextPtr_0 (call $f64_to_str (call $list_get (i32.const 0) (i32.trunc_f64_s (f64.sub (f64.add (call $getVariable (i32.const 1144)) (f64.const 0)) (f64.const 1))))))
          (call $setDialogType_0 (i32.const 1))))
          ;; change_variable: 변수
          (call $setVariable (i32.const 1144)
            (f64.add (call $getVariable (i32.const 1144)) (f64.const 1)))
          ;; Add tiny delay and stay at same PC for next iteration
          (global.set $thread_0_resumeDepth (i32.const 1))
          (global.set $thread_0_waiting (f64.const 0.001))
          (return (i32.const 1))
          (local.set $pc (i32.add (local.get $pc) (i32.const 1)))
          (global.set $thread_0_pc (local.get $pc))
          (global.set $thread_0_resumeDepth (i32.const 0))

...
// ===== VARIABLE DATA =====
const VARIABLE_DATA = [
    { id: "sqr3", name: "변수", memoryOffset: 1144, visible: true },
    { id: "brih", name: "초시계", memoryOffset: 1152, visible: false },
    { id: "1vu8", name: "대답", memoryOffset: 1160, visible: false },
];


// ===== LIST DATA =====
const LIST_DATA = [
    { id: "jod8", name: "리스트", memoryIndex: 0, visible: true },
];

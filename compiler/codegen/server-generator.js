 ...
 * Server Generator
 * 
 * Generates a Node.js server that:
 * - Serves static files from the output directory
 * - Proxies requests to playentry.org to avoid CORS issues
 */

/**
 * Generate the server JavaScript code
 * @param {Object} project - Parsed project
 * @param {Object} options - Compiler options
 * @returns {string} JavaScript code for server.js
 */
function generateServer(project, options = {}) {

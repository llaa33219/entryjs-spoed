(module
  ...
  (global $str_pool_ptr (mut i32) (i32.const 16001176))
  ...
  (global $thread_5_loopCounter (mut i32) (i32.const -1))
  ...
  (global $thread_6_loopCounter (mut i32) (i32.const -1))
  ...
  (global $thread_7_loopCounter (mut i32) (i32.const -1))
  ...
  (global $thread_8_loopCounter (mut i32) (i32.const -1))
  ...
  (global $thread_9_loopCounter (mut i32) (i32.const -1))
  ...
  (func $init
    ...
    ;; Set metadata: length=0, capacity=1000000, data_ptr=1176
    (i32.store (i32.const 1152) (i32.const 0))
    (i32.store (i32.const 1156) (i32.const 1000000))
    (i32.store (i32.const 1160) (i32.const 1176))
  ...
  (func $tick (param $dt f64)
    ...
    (if (i32.and
      ...
      (then
        ...
        (global.set $thread_1_loopCounter (i32.const -1))
